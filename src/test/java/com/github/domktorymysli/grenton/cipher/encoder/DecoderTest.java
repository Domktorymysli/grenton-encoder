...
public class DecoderTest extends TestCase {
    ...
    public void testDecode1() throws Exception {
         ...
         */
        String s = "10636185295a6dbd45670d1e05db7d45324422c5548e8fc2014e4da013ba7626390db91181f95e73a2430e446d97d1cc5d6d6e535f96a598e00a0e99f0e51248";

        MessageEncoded msg = MessageEncoded.createFromString(s);

        MessageDecoded messageDecoded = decoder.decode(msg);

        assertEquals("req:192.168.1.104:00be11:DOUT_8565:execute(2, 0)\r\n", messageDecoded.toString());
    }
    ...
    public void testDecode2() throws Exception {
        ...
        /*
         ...
         :h#8cB}gY*@:>
         */
        String s = "d891bb00a53a9a19c168bdf1f023e50e4a040f5f255b9ded276433489d67a278";

        MessageEncoded msg = MessageEncoded.createFromString(s);

        MessageDecoded messageDecoded = decoder.decode(msg);

        assertEquals("resp:192.168.2.200:0000be11:nil", messageDecoded.toString());
    }
    ...
    public void testDecode3() throws Exception {
        ...
        W
        */
        String s = "d891bb00a53a9a19c168bdf1f023e50e4edfe1d397350f3b2cb643e6b243d8df0bd5931b4876a4c926cac5fa5ef7d0138198aac3e7b720a31230e18d58ffb8313dc80ded3a123e0ef1b20a9ef7570bda";

        MessageEncoded msg = MessageEncoded.createFromString(s);

        MessageDecoded messageDecoded = decoder.decode(msg);

        assertEquals("resp:192.168.2.200:00009fe5:clientReport:210:{0,1,0,0,1,1,0,0}", messageDecoded.toString().trim());
    }
